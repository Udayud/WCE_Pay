...
public class HomeActivity extends AppCompatActivity
    ...
    private Button noticeBoard,feePayment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noticeBoard = findViewById(R.id.btnoticeboard);
        feePayment = findViewById(R.id.btfeepayment);
        ...
        feePayment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(HomeActivity.this,FeeActivity.class));
            }
        });
        ...
        usernameTextView.setText(Prevalent.currentonlineusers.getFullname());
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            startActivity(new Intent(HomeActivity.this,AdminStudentPassbook.class));
        }*/
